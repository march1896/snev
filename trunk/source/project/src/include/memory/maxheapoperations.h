...
// we would obtain something like this: "  static void* _new_debug_new(__FILE, __LINE__)( size_t size );",
...
public:
	...
	/// \param[in] e: A std::nothrow_t to specify that no exception should be thrown
	  static void* operator new( size_t size, const std::nothrow_t & e );
	...
	/// \param[in] filename: The name of the file that contains the call to new - may be NULL
	/// \param[in] line: The line number in the file that contains the call to new
	  static void* operator new( size_t size, int block_type, const char* filename, int line );
	...
	/// \param[in] filename: The name of the file that contains the call to new - may be NULL
	/// \param[in] line: The line number in the file that contains the call to new
	  static void* operator new( size_t size, const std::nothrow_t & e, const char * filename, int line );
	...
	/// \param[in] flags: Flags specifying whether any special operations should be done when allocating memory
	  static void* operator new( size_t size, unsigned long flags );
	...
	/// \param[in] e: A std::nothrow_t to specify that no exception should be thrown
	/// \param[in] flags: Flags specifying whether any special operations should be done when allocating memory
	  static void* operator new( size_t size, const std::nothrow_t & e, unsigned long flags );
	...
	/// \param[in] ptr: The void pointer to the object to be deleted  
	/// \param[in] e: A std::nothrow_t to specify that no exception should be thrown
	  static void operator delete( void * ptr, const std::nothrow_t& e );
	...
	/// \param[in] filename: The name of the file that contains the call to delete - may be NULL
	/// \param[in] line: The line number in the file that contains the call to delete 
	  static void operator delete( void * ptr, int block_type, const char * filename, int line );
	...
	/// \param[in] filename: The name of the file that contains the call to delete - may be NULL
	/// \param[in] line: The line number in the file that contains the call to delete 
	  static void operator delete( void * ptr, const std::nothrow_t & e, const char * filename, int line );
	...
	/// \param[in] ptr: The void pointer to the object to be deleted  
	/// \param[in] flags: Flags specifying whether any special operations should be done when allocating memory.
	  static void operator delete( void * ptr, unsigned long flags );
	...
	/// \param[in] e: A std::nothrow_t to specify that no exception should be thrown
	/// \param[in] flags: Flags specifying whether any special operations should be done when allocating memory.
	  static void operator delete( void * ptr, const std::nothrow_t & e, unsigned long flags );
	...
	/// \param[in] placement_ptr: The location where the initialization should take place
	  static void* operator new( size_t size, void * placement_ptr );
	...
	/// \param[in] placement_ptr: Location where the destruction should take place. Should be the same as ptr.
	  static void  operator delete( void * ptr, void * placement_ptr );
