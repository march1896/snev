...
#ifdef _MEM_DEBUG_
inline void* operator new 		( size_t Size, uint p1, uint p2, uint Line, const char* FileName ) 	{ return AllocateLowDebug( Size, Line, FileName ); }
inline void* operator new[] 	( size_t Size, uint p1, uint p2, uint Line, const char* FileName ) 	{ return AllocateLowDebug( Size, Line, FileName ); }
...
//inline void  operator delete[] 	( void* Mem,   size_t size, uint p2, uint Line, const char* FileName ) 	{ return FreeDebug( Mem, Line, FileName ); }
inline void 	operator delete( void* Mem ) 			{ FreeClean( Mem ); }
inline void 	operator delete[]( void* Mem ) 			{ FreeClean( Mem ); } 
#define new new( 0, 0, __LINE__, __FILE__ )
//#define delete delete( 0, __LINE__, __FILE__ )

#else // !_MEM_DEBUG_
inline void* 	operator new( size_t Size ) 			{ return AllocateClean( Size ); }
inline void* 	operator new[]( size_t Size ) 			{ return AllocateClean( Size ); }
inline void 	operator delete( void* Mem ) 			{ FreeClean( Mem ); }
inline void 	operator delete[]( void* Mem ) 			{ FreeClean( Mem ); } 
#endif // _MEM_DEBUG_
